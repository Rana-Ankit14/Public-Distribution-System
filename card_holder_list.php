...
<body>
	<div class="container-fluid" style="padding: 0px;">
		...
		<div style="text-align: right;">
			...
			<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Enter New Card Holder</button>
		...
		<div>
			<?php include("card_holder_list_table.php") ?>
		</div>
		</div>										<!-- content end -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="text-align: center;">Enter New Card</h4>
      </div>
      <div class="modal-body">
       		<?php  include("new_card.php"); ?>
      </div>
